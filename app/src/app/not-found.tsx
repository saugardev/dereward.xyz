...
export default function NotFoundPage() {
  return (
    <div>
      <div className="relative isolate overflow-hidden h-[80vh]">
        <div className="mx-auto items-center max-w-7xl pb-24 sm:pb-32 lg:flex py-32">
          <div className="mx-auto w-full max-w-3xl lg:mx-0 lg:flex-shrink-0 text-center lg:text-left py-10 tracking-wider">
            <div className="">
          ...
          <Image
            ...
            width={1000}
            height={1000}
            className="w-[23rem] lg:w-[28rem] w-[23rem] lg:h-[28rem] rounded-full mx-auto opacity-80"
          />
        </div>
      </div>
            <div
