  ...
  return (
    <div className="mx-auto flex justify-between items-center max-w-7xl py-5 text-stone-700">
      ...
      <div className="flex items-center">
        ...
        <Link href='/dashboard' className="mx-auto lg:mx-0 rounded-full transition-all px-5 hover:bg-stone-700 hover:text-white focus-visible:px-7 py-4 text-md text-stone-700 shadow-sm bg-white shadow-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-700">Open App</Link>
      </div>
    </div>
